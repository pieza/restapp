...
function EditarRestaurantes({ data }) {
  const service = new Service()
  ...
  return (
    <>
      <UserHeader />
      <BaseForm title="Editar Restaurantes" item={item} callback={callback}>
...
EditarRestaurantes.layout = Admin;

export default EditarRestaurantes;
