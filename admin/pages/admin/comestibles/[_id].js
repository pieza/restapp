...
function EditarComestibles({ data }) {
  const service = new Service()
  ...
  return (
    <>
      <UserHeader />
      <BaseForm title="Editar Comestibles" item={item} callback={callback}>
...
EditarComestibles.layout = Admin;

export default EditarComestibles;
